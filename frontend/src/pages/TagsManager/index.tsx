      ...
      {loading ? (
        ...
        <>
          ...
          <section className="mb-6">
            ...
            {active.length === 0 && (
              <p className="text-sm text-gray-400">No active tags.</p>
            )}
              ...
              {active.map((t) => (
                ...
                >
                  ...
                  <button
                    ...
                    title="Archive tag"
                    className="text-gray-400 hover:text-amber-600 transition-colors text-xs px-1 py-0.5 rounded-full hover:bg-amber-50"
                  >
                    archive
                  </button>
                </div>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-2">
                {archived.map((t) => (
                  <div
                    key={t.id}
                    className="flex items-center gap-1.5 bg-gray-50 border border-gray-200 rounded-full pl-3 pr-1.5 py-1 opacity-60"
                  >
                    <span className="text-sm text-gray-500">#{t.name}</span>
                    <button
                      onClick={() => toggleStatus(t)}
                      title="Reactivate tag"
                      className="text-gray-400 hover:text-green-600 transition-colors text-xs px-1 py-0.5 rounded-full hover:bg-green-50"
                    >
                      reactivate
                    </button>
                  </div>
